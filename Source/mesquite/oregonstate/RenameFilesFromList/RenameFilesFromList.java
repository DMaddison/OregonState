...
package mesquite.oregonstate.RenameFilesFromList; 
...
/* ======================================================================== */
public class RenameFilesFromList extends UtilitiesAssistant{ 
	...
	public boolean startJob(String arguments, Object condition, boolean hiredByName){
		...
		addMenuItem(null, "Rename Files from List [DRM Lab]...", makeCommand("rename", this));
		return true;
	}
	/*.................................................................................................................*
	...
	public String codeIsInCodeListFile(String codeToMatch) {
		if (sampleCodeListParser==null)
			return null;
		if (StringUtil.blank(codeToMatch))
			return null;
		String sampleCodeString  = codeToMatch;
		...
		for (int i=0; i<files.length; i++) {
			...
			if (files[i]==null )
				...
				if (cFile.exists() && !cFile.isDirectory() && (!files[i].startsWith("."))) {
					...
					while (StringUtil.notEmpty(token)) {
						if (token.startsWith("&a")) {  //get accession number
							codeToMatch=token.substring(2);
						}
						token = parser.getNextToken();
					}
			...
			//			continue;
					...
					String matchLine = codeIsInCodeListFile(codeToMatch);
	...
	public String getName() {
		return "Rename Files by List [DRM Lab]";
	}
	/*.................................................................................................................*/
